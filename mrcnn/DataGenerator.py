...
class DataLoader(Sequence):
    ...
    def __getitem__(self, idx):
        """Method to load data for the training loop"""
        ...
        outputs =  [] # ,batch_gt_class_ids, batch_gt_boxes, batch_gt_masks
        inputs = [batch_images, batch_image_meta,batch_rpn_match, batch_rpn_bbox, batch_gt_class_ids, batch_gt_boxes, batch_gt_masks, Inputanchors]
